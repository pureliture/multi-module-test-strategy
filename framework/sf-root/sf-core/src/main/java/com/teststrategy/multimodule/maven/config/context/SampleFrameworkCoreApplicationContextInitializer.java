...
public class SampleFrameworkCoreApplicationContextInitializer
     ...
     *  WaffulAnnotationBeanNameGenerator 에서는 BeanName 이 중복될 경우 FullyQualifiedName(package+class)로 BeanName 을 생성한다.
     *
    ...
    private void registerSingletonBeanNameGenerator(ConfigurableApplicationContext applicationContext) {
        log.info("ApplicationContextInitializer: BeanNameGenerator WaffulAnnotationBeanNameGenerator is registered!");
